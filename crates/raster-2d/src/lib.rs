...
//!
//! Tiles are emphatically not actors. A Terraria-like world holds millions of
//! them, stored as compact arrays in chunks; only a tile with behaviour — a
//! chest, a machine — gets an actor alongside it.
